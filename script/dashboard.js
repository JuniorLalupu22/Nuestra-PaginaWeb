...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${years} ${yearText}, ${months} ${monthText} y ${days} ${dayText}, desde que comenzó nuestra historia de amor. Me alegra mucho estar a tu lado y disfrutar cada momento. ¡Te Quierooo❤️!`;
  }
});
...
const mensajes = [
    ...
    "Gracias por alegrarme todos mis dias. ☀️",
    "Mi Amor Bonito. 💓",
];
